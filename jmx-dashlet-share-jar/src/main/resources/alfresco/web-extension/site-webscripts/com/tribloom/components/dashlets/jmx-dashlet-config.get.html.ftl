<div id="${args.htmlid}-configDialog" class="jmxdashlet-config-dialog">
    ...
    <div class="bd">
        <form id="${args.htmlid}-form" action="" method="POST">
            ...
            <div class="yui-gd">
                <div class="yui-u first"><label for="${args.htmlid}-vizlib">${msg("label.vizlib")}:</label></div>
                <div class="yui-u">
                    <select id="${args.htmlid}-vizlib" name="vizlib">
                        <option value="raphael">${msg("label.vizlib.raphael")}</option>
                        <#-- <option value="d3">${msg("label.vizlib.d3")}</option> -->
                    </select>
                </div>
            </div>
            <div class="bdft">
